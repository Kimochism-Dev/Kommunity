        ...
        <div class="left-admin">
          ...
          <div class="wrapper-bottom">
            <div class="data-reports-box">
              <h3>Desempenho de posts por tags</h3>
              <select id="" name="">
            ...
            <div class="data-reports-box">
              <h3>Ainda não tem uma função</h3>
              <select id="" name="">
                <option value="" selected disabled hidden>
                  Escolha aqui
                </option>
        ...
        <div class="right-admin">
          <div class="box-list">
            ...
            <div v-if="postPurchasable.length">
              <item-post-admin v-for="(postPur, i) in postPurchasable" :key="i" :post="postPur" />
            </div>
            <div v-else class="empty-content">
              <img src="https://s3.getstickerpack.com/storage/uploads/sticker-pack/genshin-impact-qiqi/sticker_10.png?8a65468de2ac98e87dc9b6ddbe8502a9&d=200x200" alt="">
          ...
          <div class="box-list">
            ...
            <div v-if="postOur.length">
              <item-post-admin v-for="(postPurchased, i) in postOur" :key="i" :post="postPurchased" />
            </div>
            <div v-else class="empty-content">
              <img src="https://s3.getstickerpack.com/storage/uploads/sticker-pack/genshin-impact-qiqi/sticker_10.png?8a65468de2ac98e87dc9b6ddbe8502a9&d=200x200" alt="">
              <span>Nada por aqui...</span>
